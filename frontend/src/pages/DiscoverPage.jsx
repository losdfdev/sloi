        ...
        {profiles.length > 0 && hasSwipesLeft ? (
          ...
          <div className="bg-[#141415] border border-indigo-500/10 rounded-3xl p-10 text-center text-white relative flex flex-col items-center z-10">
            ...
            <button
              ...
              disabled={refreshing}
              className={`w-full bg-white/10 text-white font-bold py-3.5 rounded-2xl hover:bg-white/20 transition relative z-20 flex items-center justify-center gap-2 ${refreshing ? 'opacity-50 cursor-not-allowed' : ''}`}
            >
              {refreshing ? (
                <>
